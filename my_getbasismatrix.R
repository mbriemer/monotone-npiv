# Extension of the function getbasismatrix from the fda package to accomodate the monotone "regression splines" basis functions used by Chetverikov & Wilhelm (2017).
# Based on fda 6.1.4, copied from https://github.com/cran/fda/blob/master/R/getbasismatrix.R
